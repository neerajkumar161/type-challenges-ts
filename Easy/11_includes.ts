...
// Other solution could be map Array into object, it doesn't fulfill all conditions

type IncludesAnother<T extends readonly any[], U> = {
  [K in T[number]]: K;
}[U] extends T[number]
  ? true
  : false;
...
type cases = [
  ...
  Expect<Equal<Includes<[1], 1 | 2 | 3>, false>>,
